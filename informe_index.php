...
function SendEnter (event) {
		...
		if (keyCode == 13) {		
				postAx('informe_validaPassword.php','user='+document.ss.username.value+'&pass='+document.ss.password.value,'passWrong',15);			
		} 
		else
		return true;
	}   
               ...
               <tr>
                ...
                <tr>
                  <td bgcolor="#efefef" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td  align="center"><font color="red"><div id="passWrong" style="height:25px;"><?php echo "Input User Name and Password"; ?></div></font></td>
                      </tr>
                    </table></td>
                </tr>
              </table>
