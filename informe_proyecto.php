...
<script type="text/javascript">		
	...
	function informe_proyecto_nuevo(Pro_ID,Informe_ID) 
	{				
		url = 'informe_proyecto_nuevo.php?Pro_ID='+Pro_ID+'&Informe_ID='+Informe_ID;	
	...
	function informe_proyecto_nuevo_registrar(Pro_ID, email) 
	{		
		...
		//{
			...
			YesNo=$('input[name=YesNo]:checked', '#Form_Informe_Proyecto_Nuevo').val();
			rate=$('input[name=rate]:checked', '#Form_Informe_Proyecto_Nuevo').val();	
			//substrates=$('input[name=substrates]:checked', '#Form_Informe_Proyecto_Nuevo').val();
			substrates=0;
			Drywall=$('input[name=Drywall]:checked', '#Form_Informe_Proyecto_Nuevo').val();	
			...
			datos=datos+'&substrates='+substrates;	
			datos=datos+'&Drywall='+$('input[name=Drywall]:checked', '#Form_Informe_Proyecto_Nuevo').val();	
			
			//datos=datos+'&Contenido='+$("#Div_Form_Informe").html();
			//alert ($("#Div_Form_Informe").html());
			//datos=datos+'&Contenido=HOLA';
			
			datos=datos+'&Pro_ID='+Pro_ID;	
			datos=datos+'&email='+email;		
			//if ( (YesNo!= undefined) && (rate!= undefined) && (substrates!= undefined) && (Drywall!= undefined) )
			if ( (YesNo!= undefined) && (rate!= undefined) && (substrates!= undefined) && (Drywall!= undefined) )
				//postAx(url,datos,'Res_Informe',100);
				postAx(url,datos,'Div_Form_Informe',100);
				
			else
				alert("Los campos Select son obligatorios!!!");
