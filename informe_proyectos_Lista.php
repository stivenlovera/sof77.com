...
<?php   				       
	...
	if ( $_GET['Name'] != ""  )
	$consulta = $consulta." AND p.Nombre like '%".$_GET['Name']."%'  ";   
	...
	?>	
            ...
            <tr onClick="javascript:informe_proyecto_Menu(<?php echo  $Pro_ID?>,'<?php echo  $Nombre;?>');" >					
                <td align="right" style="font-size:x-small"><?php echo  $Codigo; ?></td>
                <td align="right" style="font-size:x-small">  
	                <a href="javascript:informe_proyecto_Menu(<?php echo  $Pro_ID?>,'<?php echo  $Nombre;?>');"> <?php echo $Nombre; ?> </a> 				
                </td>
