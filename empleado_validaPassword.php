<?php
	...
	{
		echo "Error on User or Password ";
	}
	else
	{		
...
?>
			<span style="display:block; text-align:center" ><img src="images/indicator.gif" width="16" height="16" onload="window.open('empleado_registro.php','_self'); "  align="middle"/></span>
