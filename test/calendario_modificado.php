...
function mostrar_calendario($mes,$ano){
	...
	echo '<tr><td colspan="'.$ultimo_dia.'" class="tit">';
	...
	echo '<a href="calendario_index.php?nuevo_mes=' . $mes_anterior . '&nuevo_ano=' . $ano_anterior .'"><span>&lt;&lt;</span></a></td>';
	...
	echo '<a href="calendario_index.php?nuevo_mes=' . $mes_siguiente . '&nuevo_ano=' . $ano_siguiente . '"><span>&gt;&gt;</span></a></td>';
	...
	while ($i<$ultimo_dia)
	{
		...
		switch ($j) {
			case 0:
				echo "<td width='14%' class='diasemana'><span>L</span></td>";
				break;
			case 1:
				echo "<td width='14%' class='diasemana'><span>M</span></td>";
				break;
			case 2:
				echo "<td width='14%' class='diasemana'><span>M</span></td>";
				break;
			case 3:
				echo "<td width='14%' class='diasemana'><span>J</span></td>";
				break;
			case 4:
				echo "<td width='14%' class='diasemana'><span>V</span></td>";
				break;
			case 5:
				echo "<td width='14%' class='diasemana'><span>S</span></td>";
				break;
			case 6:
				echo "<td width='14%' class='diasemana'><span>D</span></td>";
				break;
		}
		$i++;
		$j++;
...
echo '
	...
	<tr><form action="calendario_index.php" method="POST">';
echo '
