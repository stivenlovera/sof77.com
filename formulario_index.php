    ...
    <td valign="middle"><table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td><form name="ss">
          ...
          <tr>
            <td width="50%" bgcolor="#efefef" ><table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr height="20">
                <td><div align="center">
                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" height="160">
                        <tr>
                          <td width="50%" rowspan="2" bgcolor="#E4E9F1" ><div align="center">&nbsp;<img src="images/loginforeman.jpg" alt="PWT" width="300" height="150" ><br>
                            <br>
                            <br>
                          </div></td>
                          ...
                          <td bgcolor="#efefef" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td  align="center"><font color="red">
                                <div id="passWrong" style="height:25px;"><?php echo "Input Username and Password"; ?></div>
                              </font></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table>
                        <div align="right"> <font color="#666666">.......</font></div></td>
                    </tr>
                  </table>
                </div></td>
              </tr>
