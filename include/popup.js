// Popup Windows - V 1.0
// Autor Asterio Benavides 2006/08
// version original Brian Gosselin w/ changes by Dynamicdrive.com
...
idlist.btns[0]=new Image(); idlist.btns[0].src="../images/minimize.gif";
idlist.btns[1]=new Image(); idlist.btns[1].src="../images/maximize.gif";
idlist.btns[2]=new Image(); idlist.btns[2].src="../images/close.gif";
idlist.btns[3]=new Image(); idlist.btns[3].src="../images/bottom_right.gif";
...
function popUp(x,y,w,h,cid,title,showonstart) { // text,title){
//var s_top=document.all? document.body.scrollTop : window.pageYOffset;
//y = s_top + y;
var bgcolor = "white";
var fontstyleset = "10pt sans-serif";
var textcolor = "black";
var shadowcolor = "white";
var bordercolor = "#dddddd";
var scrollcolor = "#d4c8d8";
//var showonstart = true;
var isresize = true;
var isdrag = true;
var titlecolor = "#31559C";
var titletextcolor = "white";

var proceedtopop=false;
var POPPERSESSION = false;
...
if (POPPERSESSION){
	...
	if (proceedtopop){
		if(w3c)	{
			...
			w=Math.max(w,100);
			h=Math.max(h,80);
			var rdiv=new subBox(w-((ie5)?18:16),h-((ie5)?18:16),15,15,'',cid+'_rs');
			if	(isresize){
				rdiv.innerHTML='<img src="../images/bottom_right.gif" width="14" height="14">';
				rdiv.style.cursor='se-resize';
				}
		tw=(ie5)?w:w+4;
		th=(ie5)?h:h+6;
		var shadow=new subBox(x+8,y+8,tw,th,shadowcolor,cid+'_s');
		if(ie5)shadow.style.filter="alpha(opacity=80)";
		...
		titlebar.innerHTML='<span id="'+cid+'_title" style="position:absolute; left:3px; top:1px; font:bold 10pt sans-serif; color:'+titletextcolor+'; height:18px; overflow:hidden; clip-height:16px;">'+title+'</span><span id="'+cid+'_btt" style="position:absolute; width:40px; height:17px; left:'+(tw-40)+'px; top:1px;"><img src="../images/minimize.gif" width="13" height="17" id="'+cid+'_min"><img src="../images/maximize.gif" width="13" height="17"  id="'+cid+'_max"><img src="../images/close.gif" width="13" height="17" id="'+cid+'_cls"></span>';
		tw=(ie5)?w-7:w-13;
		th=(ie5)?h-36:h-36;
