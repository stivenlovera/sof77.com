...
<script type="text/javascript" >
	...
	{				
		url = 'Reporte_execution_day_by_day_preview.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value;		
					...
					<table width="267" class="moduletable" >
						...
						<tr>
							<td colspan="2" align="center"><a href="#">
							  <input name="button" type="button" onclick="reporte_daily_report_preview();" value="Search" />
							</a>&nbsp;&nbsp;&nbsp;
								  <a href="#">
