...
<script type="text/javascript" >
	...
	{				
		...
		if (Pro_ID_Reporte != "-33")
		{
			...
			url = 'Proyectos_reporte_dayli_report_b_list.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&Pro_ID_Reporte='+Pro_ID_Reporte;		
	...
	{		
		...
		url = 'Proyectos_reporte_dayli_report_b_list_jobs.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&Emp_ID='+Emp_ID+'&Company='+Company+'&Nombre='+Nombre+'&Foreman_ID='+Foreman_ID+'&Project_Manager_ID='+Project_Manager_ID+'&EstatusID='+EstatusID;		
