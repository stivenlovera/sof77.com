		...
		?>		
			...
			<tr >					
				...
				<td align="right" style="font-size:x-small">
					<div id="Cantidad_Recibida-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-x"><?php echo $Cantidad_Recibida;?></div>
					<img src="images/spacer.gif" onload="Atividades_Reporte_Diario_Material('Cantidad_Recibida-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-x');" />
				</td>
				<td align="right" style="font-size:x-small">
					<div id="Cantidad_Usada-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-x"><?php echo $Cantidad_Usada;?></div>
					<img src="images/spacer.gif" onload="Atividades_Reporte_Diario_Material('Cantidad_Usada-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-x');" />
				</td>
		  </tr>
<?php
		$contador++;
