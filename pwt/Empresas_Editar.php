...
?> 
    <form id="Form_Empresas_Editar" name="Form_Empresas_Editars">
    <table>
    	<tr>
        	<td width="500">             
				<fieldset>
					...
					<table  cellpadding="2" cellspacing="2">
						<tr>
							...
							<td >
								<input name="Codigo" type="text" id="Codigo" size="16" value="<?php echo $Codigo;?>" onblur="Empresas_Nueva_Validar_Codigo(this.value, <?php echo $Emp_ID;?>);"/>
								<label for="Codigo" generated="true" class="error"></label><span id='Div_Validar_Codigo'>OK</span>
							</td>
						</tr>
						<tr>
						...
						<tr>							
							...
							<td>
								<input name="Gerente_General" type="text" id="Gerente_General" size="50" value="<?php echo $Gerente_General;?>"/>
							</td>
					  	</tr>
						<tr>
							<td ><strong>Street:</strong></td>
							<td>
								<input name="Calle" type="text" id="Calle" size="50" value="<?php echo $Calle;?>"/>
						...
						<tr>
						    ...
						    <td><input name="Telefono" type="text" id="Telefono" size="15" value="<?php echo $Telefono;?>"/>
								...
								<input name="Emp_ID" type="hidden" id="Emp_ID" size="20" value="<?php echo $Emp_ID;?>"/>
						  </td>
						</tr>	
						<tr>
		...
		<tr>
			<td valign="top">                                            
				<div style="display:block" id="div_res_new_empresa">					
					<INPUT  id="Bnt_Empresa_Editar_Guardar"  name="Bnt_Empresa_Editar_Guardar" type="button" value="Save" >	
                </div>                                  								
           	</td>       
		</tr>
	</table>
</form>
<img src='images/spacer.gif' onload='Iniciar_Validacion_Empresa_Editar();' />
<?php
