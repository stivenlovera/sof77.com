...
<fieldset id="Fs_Lista_Cliente" class="" >
	...
	<legend>List Level 1:Buildings:<a href="#"><img src="images/icon_nuevo_sintxt_0_gif.gif" onclick='Proyectos_Piso_Nuevo(<?php echo $Pro_ID;?>,<?php echo $Edificio_ID; ?>);' alt="New Floor"/></a> </legend>
	...
	<?php   				       	
		...
		$consulta = "SELECT * FROM floor WHERE Edificio_ID=".$Edificio_ID." ORDER BY Nombre ";		
					...
					<table>
						...
						<tr>								 
							...
							<td>
								...
								<span id="icon_tree_open_<?php echo $Floor_ID;?>" style="display:block"><img src="images/desplegar.gif" onclick="Proyectos_Piso_Expandir(<?php echo  $Floor_ID; ?>);" width="16" /></span>

								<span id="icon_tree_close_<?php echo $Floor_ID;?>" style="display:none" > <img src="images/contraer.gif" onclick="Proyectos_Piso_Contraer(<?php echo  $Floor_ID; ?>);" /></span>
							...
							<td>								
								...
								<img src="images/button_edit.gif" border="0" width="16" onclick="Proyectos_Piso_Editar(<?php echo $Floor_ID; ?>);" alt="Edit"/>	
							...
							<td>
								...
								<a href="#">
									...
									<img src="images/icon_eliminar_0_gif.gif" border="0" width="16" onclick="Proyectos_Piso_Eliminar(<?php echo $Floor_ID; ?>,<?php echo $Pro_ID; ?>);" alt="Delete"/>		
