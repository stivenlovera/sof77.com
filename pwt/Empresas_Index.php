<?php
	...
	require('funciones_php/Empresas.php');	
...
<script type="text/javascript">
	function Iniciar_Validacion_Empresa_Nueva()
	{			
		$().ready(function() {
			// validate the comment form when it is submitted
			$("#Form_Empresas_Nueva").validate({
				rules: {
					Codigo:"required",
					Nombre:"required",
					Zip_Code: {					
			...
			$("#Bnt_Empres_Nueva").click(function() 
			{
			  if ( $("#Form_Empresas_Nueva").valid() )
			  {
					Empresas_Nueva_Registrar(); 		
			  }
			  else
			  {		  	
	...
	function Iniciar_Validacion_Empresa_Editar()
	{			
		$().ready(function() {
			// validate the comment form when it is submitted
			$("#Form_Empresas_Editar").validate({
				rules: {
					Codigo:"required",
					Nombre:"required",
					Zip_Code: {					
			...
			$("#Bnt_Empresa_Editar_Guardar").click(function() 
			{
				if ( $("#Form_Empresas_Editar").valid() )
				{
					Empresas_Editar_Registrar(); 		
				}
				else
				{		  	
					alert("Complete some fields");	
	...
	function Iniciar_Validacion_Empresa_Proyecto_Nueva()
	{			
		$().ready(function() {
			// validate the comment form when it is submitted
			$("#Form_Empresas_Proyecto_Nuevo").validate({
				rules: {
					Codigo:"required",
					Nombre:"required",
					Ciudad:"required",
			...
			$("#Bnt_Empres_Proyecto_Nueva").click(function() 
			{
			  if ( $("#Form_Empresas_Proyecto_Nuevo").valid() )
			  {
...
<body link="#5865AF" vlink="#5865AF" alink="#5865AF" style="background: url(images/globolines.jpg)  fixed center no-repeat ;" >
<!-- English -->
			...
			<div id="ac_frmSearchMain">				  
				<form id="Form_Empresas_Lista" name="Form_Empresas_Lista">			
					<table width="267" class="moduletable" >
						<tr>
						  	<th colspan="3">Search Options - Companies </th>
						</tr>		  		 				
						<tr>
						...
						<tr>
						  ...
						  <tr>
								<td colspan="2" align="center">				  	
									  <a href="#"><input type="button" value="Search" ID="Find" Name="Find" onClick="Empresas_Lista();"  />
									  </a> &nbsp;&nbsp;&nbsp;
				...
				<fieldset id="Botono Nuevo_Cliente" class="" >
					<legend><span id="result_box" lang="en" xml:lang="en">Register New Company</span>: </legend>
					<table width="267" class="moduletable">
						<tr>
							<td>
								<a href="#">
									<input type="button" value="New" onClick="Empresas_Nueva();" />
								</a>		
							</td>
						</tr>
					</table>			
	  	...
	  	<td valign="top" width="99%">
			<table width="100%">
				<tr>
					...
					<div id="Div_Empresas_Lista">
					</div>		
					</td> 
				</tr>
				<tr>
				  <td colspan=2>					
						 <div id="Div_Empresas_Datos"></div>		
				  </td>
				</tr> 							  
				<tr>
				  <td colspan=2>					
						 <div id="Div_Empresas_Menu"></div>		
				  </td>
				</tr>				
			</table>
		</td>
