<?php	 		
	...
	require('Library/funciones.php');	
		...
		{	
			...
			$consulta7 = "SELECT p.Empleado_ID as Emp_ID,ap.*,a.* FROM actividad_personal ap join actividades a on a.Actividad_ID=ap.Actividad_ID join personal p on ap.Empleado_ID=p.Empleado_ID where a.Fecha='".$fecha."' and p.Numero=".$num_emp; 
			...
			{	
				...
				{	
					...
					$consulta9="Update actividad_personal set actividad_id=".$actID_to_put." where actividad_id=".$actID_to_rep." and empleado_ID=".$emp_ID;
					...
					$consulta9="Update registro_diario set Actividad_ID=".$actID_to_put.",Pro_ID=1617 where Actividad_ID=".$actID_to_rep." and empleado_ID=".$emp_ID;
					//$consulta9="Update registro_diario set Actividad_ID=0 where Actividad_ID=".$actID_to_rep." and empleado_ID=".$emp_ID; // to delete 

					echo $consulta9."<br>";	
						$result9=$bd->ejecutar($consulta9); 	
					$consulta9="Update registro_diario_actividad set actividad_id=".$actID_to_put." where actividad_id=".$actID_to_rep." and empleado_ID=".$emp_ID;
