...
<script type="text/javascript" >
	...
	//***********************************
	function proyectos_reporte_material_1() 
	{	
		var Nombre_Material = document.form_reporte.Nombre_Material.value	
		...
		if(form_reporte.radio[0].checked==true)
		{
			...
			url = 'proyectos_reporte_material_1.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&Nombre_Material='+Nombre_Material+'&Pro_ID_Reporte='+Pro_ID_Reporte;		
		...
		if(form_reporte.radio[1].checked==true)
		{
			...
			url = 'proyectos_reporte_material_2.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&Nombre_Material='+Nombre_Material+'&Pro_ID_Reporte='+Pro_ID_Reporte;		
			getAx(url,'basic-modal-content-espera',250);		
			$('#basic-modal-content-espera').modal(); 									
			}
	}	
			...
			<div id="ac_frmSearchMain">				  
				<form id="form_reporte" name="form_reporte">			
					<table width="267" class="moduletable" >
						...
						<tr>
							<td align="left" valign="top"><b>Material:</b>
							</td>
							<td>
						...
						<tr>
						  ...
						  <td align="center">
                            <label>
						    <input type="radio" name="radio" id="por" value="detalle" checked="checked" />
						    Detail</label>                          
                            <label>
					...
					<tr>
						...
						<tr>
							<td colspan="2" align="center"><a href="#">
							  <input name="button" type="button" onclick="proyectos_reporte_material_1();" value="Print Prev" />
							</a>&nbsp;&nbsp;&nbsp;
								  <a href="#">
