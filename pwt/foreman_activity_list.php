...
<?php   				       	
	...
	$consulta = "SELECT p.Pro_ID, p.Nombre, p.Fecha_Inicio, p.Fecha_Fin, p.Horas, a.*, ta.Actividad_Nombre FROM actividades a 
		...
		WHERE ((a.Fecha>=NOW()) OR a.Fecha='2013-01-01') ";	
		...
		?>		
			...
			<tr>											
				...
				<td >
					...
					<a style =" cursor: pointer;" onclick="Actividades_Asignar_Personal(<?php echo $Actividad_ID; ?>, '<?php echo $Fecha; ?>');"><img src="images/icon_asignar_0_gif.gif"/></a><a style =" cursor: pointer;" onclick="Actividades_Editar_Reporte(<?php echo $Actividad_ID; ?>, <?php echo $Pro_ID; ?>);">
					...
					<img src="images/color_5<?php echo $File5; ?>.jpg" value="FFFF00" name="Color_5" id="Color_5" onclick="reporte_cronograma_actividades_color('FFFF00', <?php echo $Actividad_ID; ?>);"/>			</td>
				...
				<td align="right"  style="font-size:x-small; <?php echo $Estilo; ?>">
					...
					<a style =" cursor: pointer;" onclick="Foreman_Atividades_Reporte_Diario(<?php echo $Actividad_ID; ?>, <?php echo $Pro_ID; ?>);">
	
	
	
						<?php echo "($Gc)$Codigo/$Nombre/$Address<br><b>Contac:</b>$Coordinador_Obra <b>Movil:</b>$CelularC<br><b>Foreman:</b>$Foreman <b>Movil:</b>$CelularF<br><b>PWT:</b>$Pwtpm <b>/</b>$Pwtsuper<br>"; ?>				</a>			</td>
