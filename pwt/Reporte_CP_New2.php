...
<script type="text/javascript" >
	...
	function Reporte_CP_New2_preview() 
	{			
		var Nick_Name = document.form_reporte.Nick_Name.value	
		
		url = 'Reporte_CP_New2_preview.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&Nick_Name='+Nick_Name;
                       ...
                       <tr>
						...
						<tr>
							<td colspan="2" align="center"><a href="#">
							  <input name="button" type="button" onclick="Reporte_CP_New2_preview();" value="Report" />
