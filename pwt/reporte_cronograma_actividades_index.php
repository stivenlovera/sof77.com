			...
			<div id="ac_frmSearchMain">				  
				<form id="form_reporte" name="form_reporte">			
				  ...
				  <tr>
					...
					<input type="text" id="Proyecto" name"Proyecto" value=""/>							</td>
					  </tr>
						<tr>
							<td ><b>From Date:</b></td>					
							<td colspan="2" valign="middle">
								<input type="text" id="From_Date"  datepicker="true"  datepicker_format="MM-DD-YYYY" value="<?php echo date('m-d-Y');?>"/>							</td>
						</tr>
						<tr>
							<td align="left" valign="top"><b>To Date :</b>							</td>
							<td>
								<input type="text" id="To_Date"  datepicker="true"  datepicker_format="MM-DD-YYYY" value="<?php echo date('m-d-Y');?>"/>							</td>							
						</tr>	
						<tr>
							<td colspan="2" align="center"><a href="#">
							  <input name="button" type="button" onclick="reporte_cronograma_actividades_lista();" value="  Search  " />
							</a>&nbsp;&nbsp;&nbsp;
							  <a href="#">
							<input type="reset" value="   Clear   "  /> 
							  </a>	&nbsp;&nbsp;&nbsp;
								  <a href="#">
						    <input name="button2" type="button" onclick="setuphours();" value="S.up8hrs" />							</tr>					  					  
					</table>
			  </form>				
			</div>			
				...
				<tr>
					<td>
						<table width="100%">
							<tr>
								<td width="50%">
									<div id="Div_Actividad_Material_Information"></div>
								</td>
								<td width="50%">
