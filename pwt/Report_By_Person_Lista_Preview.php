<?php
	...
	function encabezado(&$pdf,$f1,$f2)
	{
	  ...
	  $pdf->Multicell(0,5,"Report: Detail Hours/Job By Person",0,'C',false);
	...
	$consulta = "SELECT p.Empleado_ID,p.Numero,ap.Actividad_ID,p.Nombre,p.Aux5,p.Nick_Name,p.Apellido_Materno, pr.Codigo, pr.Nombre,ap.Note, a.Fecha, SUM(HContract) AS HContract, SUM(HTM) AS HTM ";
	...
	$consulta = $consulta . " ORDER BY p.Apellido_Materno,p.Nick_Name, a.Fecha, pr.Codigo, pr.Nombre  ";
