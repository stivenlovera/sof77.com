...
<fieldset>
	<legend>Submittals Information</legend>
	<table class="tabla_Datos_Items_max">
		<thead>	
		  <tr>
				<th width="620" style="font-size:x-small;">Denomination</th>
				<th width="50" style="font-size:x-small">Estimated</th>
				<th width="50" style="font-size:x-small">T.Ordered</th>
				<th width="50" style="font-size:x-small">T.Received</th>
				<th width="50" style="font-size:x-small">T.Used</th>
				<th width="50" style="font-size:x-small">% Used</th>
				<th width="50" style="font-size:x-small">Received </th>
				<th width="50" style="font-size:x-small">Used  </th>
		  </tr>	
		 </thead>	
		 <tbody>
<?php   				       	
	...
	{		
		...
		$consulta = $consulta."  WHERE pm.Mat_ID=".$Mat_ID." AND pm.Actividad_ID=".$Actividad_ID." AND pm.Task_ID=".$Task_ID." AND (NOT (pm.Cantidad_Recibida is NULL)) ";	
		//echo $consulta."<bR>";
		$result=$bd->ejecutar($consulta); 	
		...
		//$consulta = "SELECT * FROM pedidos_material pm INNER JOIN pedidos p ON pm.Ped_ID=p.Ped_ID AND p.Fecha='".$Fecha."' ";
		$consulta = "SELECT * FROM pedidos_material pm INNER JOIN pedidos p ON pm.Ped_ID=p.Ped_ID ";
		$consulta = $consulta."  WHERE pm.Mat_ID=".$Mat_ID." AND pm.Actividad_ID=".$Actividad_ID." AND pm.Task_ID=".$Task_ID."  AND (NOT (pm.Cantidad_Usada is NULL)) ";	
		//echo $consulta."<bR>";
		$result=$bd->ejecutar($consulta); 	
		if (($row = mysqli_fetch_array($result) ))							
		{	
		...
		?>		
			...
			<tr >					
				...
				<td align="right" style="font-size:x-small">
					<div id="Cantidad_Recibida-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-<?php echo  $Task_ID;?>-x"><?php echo $Cantidad_Recibida;?></div>
					<img src="images/spacer.gif" onload="Dayli_Atividades_Reporte_Diario_Material('Cantidad_Recibida-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-<?php echo  $Task_ID;?>-x');" />
				</td>
				<td align="right" style="font-size:x-small">
					<div id="Cantidad_Usada-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-<?php echo  $Task_ID;?>-x"><?php echo $Cantidad_Usada;?></div>
					<img src="images/spacer.gif" onload="Dayli_Atividades_Reporte_Diario_Material('Cantidad_Usada-<?php echo  $Pro_ID;?>-<?php echo  $Mat_ID;?>-<?php echo  $Actividad_ID;?>-<?php echo  $Task_ID;?>-x');" />
				</td>
		  </tr>
<?php
		$contador++;
...
?>	
	...
	<img src="images/spacer.gif" onload="$('.tabla_Datos_Items_max').flexigrid({nowrap: false, showTableToggleBtn : true,width : 1100,height :500, singleSelect: true	});" />  	
</fieldset>
<?php
