<?php
	...
	//echo "Empleado_ID=".$Empleado_ID."<br>";
?> 
<table>
	<tr>
    	<td>
            ...
            <?php 
                ...
                $consulta = "SELECT p.Pro_ID, p.Nombre, p.Fecha_Inicio, p.Fecha_Fin, p.Horas, a.*, ta.Actividad_Nombre FROM actividades a 
                    ...
                    $consulta = $consulta . " WHERE (a.Fecha BETWEEN '".$af1."' AND '".$af2."' )  ";
                    
                    if ($Pro_ID_Reporte!=-33)		
                        $consulta = $consulta . " AND  p.Pro_ID=".$Pro_ID_Reporte;	
                        ...
                        ?>		
                            ...
                            <tr>		
                                <td align="left"  style="font-size:x-small; <?php echo $Estilo; ?>">	
                                        <a style =" cursor: pointer;" onclick="foreman_registro_actividad_detalle2(<?php echo $Pro_ID; ?>);">
        ...
        <td valign="top">
        	<div style="overflow:scroll" ID="Div_Actividades">
            </div>
        </td>
	</tr>
</table>
