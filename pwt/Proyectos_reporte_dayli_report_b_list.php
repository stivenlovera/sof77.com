<?php
	...
	$sql = $sql . " CONCAT(em1.Nombre, ' ', em1.Apellido_Paterno, ' ',  em1.Apellido_Materno) as Foreman, ";

	$sql = $sql . " CONCAT(em3.Nombre, ' ',  em3.Apellido_Paterno, ' ',  em3.Apellido_Materno) as Manager ";
...
//echo $sql."<br>";
...

	{
		...
		$pdf->Multicell(100,5,"Job: ".$Codigo." ".$Nombre,0,L,'R'); 	
		...
		$pdf->Multicell(100,5,"PM PWT: ".$Manager,0,L,false); 	
