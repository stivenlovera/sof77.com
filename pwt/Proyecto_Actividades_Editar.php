					...
					<table  cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
							<td width="82"><b>Description</b></td>
						  	<td >
									<textarea id="Descripcion" name="Descripcion" cols="80" rows="4"><?php echo $Descripcion;?></textarea>														
							</td>
						</tr>						
						<tr>
							<td ><b>Aux 1:</b></td>
							<td><input name="Aux1" id="Aux1" type="text" size="20" value="<?php echo $Aux1;?>"/> 
							&nbsp;&nbsp;						     
							   	<b>Aux 2:</b><input name="Aux2" id="Aux2" type="text" size="20" value="<?php echo $Aux2;?>"/>
							   	&nbsp;&nbsp;						     
								<b>Aux 3:</b><input name="Aux3" id="Aux3" type="text" size="20" value="<?php echo $Aux3;?>"/>	
		...
		<tr>
			<td valign="top">                                            
				<div style="display:block" id="div_res_new_Actividades">						
					<INPUT id="button" type="button" value="Save" name="button" onClick="Proyectos_Actividades_Editar_Registrar();">   					
                </div>
           	</td>       
		</tr>		
	</table>
