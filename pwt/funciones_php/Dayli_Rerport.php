<script type="text/javascript">
	...
	{				
		...
		url = 'Dayli_Report_Lista.php?From_Date='+From_Date+'&To_Date='+To_Date+'&Proyecto='+Proyecto+'&Pro_ID=';
	...
	{				
		...
		url = 'Dayli_Report_Information.php?Actividad_ID='+Actividad_ID+'&Pro_ID='+Pro_ID;		
		getAx(url,'Div_Dayli_Information',100); 
	...
	function Dayli_Report_Piso_Expandir(Floor_ID, Actividad_ID) 
	{	
		$('#icon_tree_open_'+Floor_ID).hide();
		$('#icon_tree_close_'+Floor_ID).show();
		$('#Div_Areas_'+Floor_ID).show();
		
		url = 'Dayli_Report_Piso_Area_Lista.php?Floor_ID='+Floor_ID+'&Actividad_ID='+Actividad_ID;		
		getAx(url,'Div_Areas_'+Floor_ID,50); 	
	}
	
	function Dayli_Report_Piso_Contraer(Floor_ID) 
	{	
	...
	function Dayli_Report_Piso_Area_Expandir(Area_ID, Actividad_ID) 
	{	
		$('#icon_tree_open_area_'+Area_ID).hide();
		$('#icon_tree_close_area_'+Area_ID).show();
		$('#Div_tareas_'+Area_ID).show();
		
		url = 'Dayli_Report_Piso_Area_Tareas_Lista.php?Area_ID='+Area_ID+'&Actividad_ID='+Actividad_ID;		
		getAx(url,'Div_tareas_'+Area_ID,50); 	
	}
	
	function Dayli_Report_Piso_Area_Contraer(Area_ID) 
	{	
	...
	function Dayli_Report_Piso_Area_Task_Expandir(Task_ID, Actividad_ID) 
	{	
		$('#icon_tree_open_area_task_'+Task_ID).hide();
		$('#icon_tree_close_area_task_'+Task_ID).show();
		$('#Div_tareas_task_'+Task_ID).show();
		
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Lista.php?Task_ID='+Task_ID+'&Actividad_ID='+Actividad_ID;		
		getAx(url,'Div_tareas_task_'+Task_ID,50); 	
	}
	
	function Dayli_Report_Piso_Area_Task_Contraer(Task_ID) 
	{	
		$('#icon_tree_open_area_task_'+Task_ID).show();
		$('#icon_tree_close_area_task_'+Task_ID).hide(); 									
		$('#Div_tareas_task_'+Task_ID).hide();
	}
			 
	function Dayli_Report_Piso_Area_Tareas_Task_Nuevo(Task_ID, Actividad_ID) 
	{				
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Nuevo.php?Task_ID='+Task_ID+'&Actividad_ID='+Actividad_ID;	
		getAx(url,'basic-modal-content-espera',450); 
		$('#basic-modal-content-espera').modal();
		return false;		
	}
	function Dayli_Report_Piso_Area_Tareas_Task_Nuevo_Search(Pro_ID, Actividad_ID) 
	{				
		NumAct=document.form2.NumAct.value;
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Nuevo_Search.php?Pro_ID='+Pro_ID+'&Actividad_ID='+Actividad_ID+'&NumAct='+NumAct;	
		getAx(url,'basic-modal-content-espera',450); 
		$('#basic-modal-content-espera').modal();
		return false;		
	}
	
	function Dayli_Report_Piso_Area_Tareas_Task_Nuevo_Registrar() 
	{		
		//alert("llegue");
		datos='';		
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Nuevo_Registrar.php';	
		$(':input', $("#FORM_Dayli_Report_Piso_Area_Tareas_Task_Nuevo") ).each(function() {
			if ( (this.type!='submit') && ( this.type!='button') && ( this.type!='reset') && (this.type!='radio') )
			{
				cad=jQuery.trim(this.name);											
				cad1=jQuery.trim(this.value);				
		...
		postAx(url,datos,'Div_Dayli_Report_Piso_Area_Tareas_Task_Nuevo_res',100);
	}	
	
	function Dayli_Report_Piso_Area_Tareas_Task_Editar(Dayli_ID, Task_ID, Actividad_ID) 
	{				
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Editar.php?Dayli_ID='+Dayli_ID+'&Task_ID='+Task_ID+'&Actividad_ID='+Actividad_ID;	
		getAx(url,'basic-modal-content-espera',450); 
		$('#basic-modal-content-espera').modal();
		return false;		
	}
	
	function Dayli_Report_Piso_Area_Tareas_Task_Editar_Registrar() 
	{		
		//alert("llegue");
		datos='';		
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Editar_Registrar.php';	
		$(':input', $("#FORM_Dayli_Report_Piso_Area_Tareas_Task_Editar") ).each(function() {
			if ( (this.type!='submit') && ( this.type!='button') && ( this.type!='reset') && (this.type!='radio') )
			{
				cad=jQuery.trim(this.name);											
				cad1=jQuery.trim(this.value);				
	...
	function Dayli_Report_Piso_Area_Tareas_Task_Eliminar(Dayli_ID, Task_ID, Actividad_ID) 
	{		
		if (confirm("Are you Sure Deleted this Record"))
		{
			url = 'Dayli_Report_Piso_Area_Tareas_Task_Eliminar.php?Dayli_ID='+Dayli_ID+'&Task_ID='+Task_ID+'&Actividad_ID='+Actividad_ID;		
			getAx(url,'Div_tareas_task_'+Task_ID,250); 									
		}
	}
	
	
	function Dayli_Report_Piso_Area_Tareas_Task_Material(Task_ID, Actividad_ID) 
	{				
		url = 'Dayli_Report_Piso_Area_Tareas_Task_Material.php?Task_ID='+Task_ID+'&Actividad_ID='+Actividad_ID;	
		getAx(url,'basic-modal-content-espera',450); 
		$('#basic-modal-content-espera').modal();
		return false;		
	}
	
	function Dayli_Atividades_Reporte_Diario_Material(ID_Editable) 
	{
		eval( "$('#"+ID_Editable+"').editable('Dayli_Atividades_Reporte_Diario_Material.php');" );		 			 
	}	
