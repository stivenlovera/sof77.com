<script type="text/javascript">
	...
	function Actividades_Personal_a_Asignardet(Actividad_ID, Fecha) 

	{				

		url = 'Actividades_Personal_a_Asignardet.php?Fecha='+Fecha+'&Actividad_ID='+Actividad_ID;	
	...
	function Actividad_Material_Information(Actividad_ID, Pro_ID) 
	{	
		url = 'Actividad_Material_Information.php?Actividad_ID='+Actividad_ID+'&Pro_ID='+Pro_ID;
		getAx(url,'Div_Actividad_Material_Information',50); 
	}
	
	function Actividad_Task_Information(Actividad_ID, Pro_ID) 
	{	
		url = 'Actividad_Task_Information.php?Actividad_ID='+Actividad_ID+'&Pro_ID='+Pro_ID;
		getAx(url,'Div_Actividad_Task_Information',50); 
	}
	
	function Actividad_Personal_Information(Actividad_ID, Pro_ID) 
	{	
		url = 'Actividad_Personal_Information.php?Actividad_ID='+Actividad_ID+'&Pro_ID='+Pro_ID;
		getAx(url,'Div_Actividad_Personal_Information',50); 
	}
	
	function Actividad_Re_Scheduling(Actividad_ID, Pro_ID) 
	{	
		url = 'Actividad_Re_Scheduling.php?Actividad_ID='+Actividad_ID+'&Pro_ID='+Pro_ID;
		getAx(url,'Div_Actividad_Re_Scheduling',50); 
	}
	...
	{	
		...
		/*Actividad_Material_Information(Actividad_ID, Pro_ID);
		Actividad_Task_Information(Actividad_ID, Pro_ID);
		Actividad_Personal_Information(Actividad_ID, Pro_ID);
		Actividad_Re_Scheduling(Actividad_ID, Pro_ID);*/	
...
function Admforeman_registro_actividad_detalle(Actividad_ID, Pro_ID) 

	{				

		url = 'Admforeman_registro_actividad_detalle.php?Actividad_ID='+Actividad_ID+'&Pro_ID='+Pro_ID;		
