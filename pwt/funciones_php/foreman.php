<script type="text/javascript">
	...
	function makeactive(tab, Reg_ID, Pro_ID)
	{ 
		Activar_Tab(tab);
		switch(tab) 
		{
			case 1 : 	{
							if (tabActivo1 == "" )
							{
								foreman_registro_actividad_asistencia(Reg_ID, Pro_ID);	
								$('#Div_Reporte').html("");															
							}			
							break;
						}
	...
	function foreman_menu(Reg_ID, Pro_ID) 
	{			
		url = "foreman_menu.php?Reg_ID="+Reg_ID+"&Pro_ID="+Pro_ID;			
		getAx(url,'Div_Actividad_Personal_Information',10); 									
	}   
		
	function foreman_registro_actividad_asistencia(Reg_ID, Pro_ID) 
	{			
		url = "foreman_registro_actividad_asistencia.php?Reg_ID="+Reg_ID+"&Pro_ID="+Pro_ID;			
		getAx(url,'Div_Registro',10); 									
	} 
	...
	{			
		...
		getAx(url,'div_registro_borrar_'+MiFila,250);													
	} 
