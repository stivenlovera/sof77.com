...
<script type="text/javascript" >
	...
	{		
		...
		url = 'Report_By_Person_Lista.php?Fecha_Inicio_Busqueda='+Fecha_Inicio_Busqueda+'&Fecha_Fin_Busqueda='+Fecha_Fin_Busqueda;		
	...
	{		
		...
		var Fecha_Inicio_Busqueda = document.form_reporte.Fecha_Inicio_Busqueda.value
		var Fecha_Fin_Busqueda = document.form_reporte.Fecha_Fin_Busqueda.value	
		var Nombre_Empleado = document.form_reporte.Nombre_Empleado.value	
		...
		if (form_reporte.radio[0].checked==true)
		{
			...
			url = 'Report_By_Person_Lista_Preview.php?Fecha_Inicio_Busqueda='+Fecha_Inicio_Busqueda+'&Fecha_Fin_Busqueda='+Fecha_Fin_Busqueda+'&Nombre_Empleado='+Nombre_Empleado+'&Nick_Name='+Nick_Name+'&Pro_ID_Reporte='+Pro_ID_Reporte;		
		...
		if(form_reporte.radio[1].checked==true)
		{
			...
			url = 'Report_By_Person_Total_Preview.php?Fecha_Inicio_Busqueda='+Fecha_Inicio_Busqueda+'&Fecha_Fin_Busqueda='+Fecha_Fin_Busqueda+'&Nombre_Empleado='+Nombre_Empleado+'&Nick_Name='+Nick_Name+'&Pro_ID_Reporte='+Pro_ID_Reporte;		
			getAx(url,'basic-modal-content-espera',250);		
			$('#basic-modal-content-espera').modal(); 			
		}
		...
		{
			//alert(form_reporte.From_Date.value);			
			url = 'Report_By_Person_CosCod_Preview.php?Fecha_Inicio_Busqueda='+Fecha_Inicio_Busqueda+'&Fecha_Fin_Busqueda='+Fecha_Fin_Busqueda+'&Nombre_Empleado='+Nombre_Empleado+'&Nick_Name='+Nick_Name+'&Pro_ID_Reporte='+Pro_ID_Reporte;		
			getAx(url,'basic-modal-content-espera',250);		
			$('#basic-modal-content-espera').modal(); 			
		}
			  ...
			  <form id="form_reporte" name="form_reporte">			
					...
					<table width="267" class="moduletable" >
						...
						<tr>
							...
							<td align="left" valign="top"><b>Type employee </b></td>

							<td>

								<p>F=Field and PWT FU=Field and Union FS:</b>Field and Sub
								  <input name="Nombre_Empleado" type="text" id="Nombre_Empleado" size="10" />
							  </p>
						...
						<tr>
							...
							<td align="left" valign="top"><b>Nick Name or Name:</b>
						  ...
						  <td align="center">
						    ...
						    .</label>                         
                             <label>With  CostCode:
						       ...
						       <input type="radio" name="radio" id="por" value="codcos" />

						    </label> 
                            <label>Employee By job:

						       <input type="radio" name="radio" id="por" value="job" />
