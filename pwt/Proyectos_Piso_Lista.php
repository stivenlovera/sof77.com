...
<fieldset id="Fs_Lista_Cliente" class="" >
	...
	<legend>List Level 1: Buildings </legend>
					...
					<table>
						...
						<tr>								 
							...
							<td>
								...
								<span id="icon_tree_open_<?php echo $Floor_ID;?>" style="display:block"><img src="images/desplegar.gif" onclick="Proyectos_Piso_Expandir(<?php echo  $Floor_ID; ?>);" width="12" /></span>
