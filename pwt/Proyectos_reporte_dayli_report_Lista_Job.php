...
<?php   				       
	...
	$consulta = "SELECT p.*, s.*,e.Nombre as Company FROM proyectos p INNER JOIN estatus s on p.Estatus_ID=s.Estatus_ID INNER JOIN empresas e ON p.Emp_ID=e.Emp_ID WHERE ";	
