<?php	 		
	...
	$consulta = $consulta."  WHERE pm.Mat_ID=".$Mat_ID." AND (NOT (pm.".$tipo." is NULL)) ";	
	//echo $strSQL."<br>";				
	...
	{	
		...
		$strSQL = "INSERT INTO pedidos_material (Ped_ID, Mat_ID, ".$tipo.") ";	
		$strSQL = $strSQL . " values (".$Ped_ID."," . $Mat_ID . "," .$value. ")";
