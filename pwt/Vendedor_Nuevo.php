...
?> 
    <form id="Form_Vendedor_Nuevo" name="Form_Vendedor_Nuevo">
    <table>
    	<tr>
        	<td width="500">             
				<fieldset>
					...
					<table  cellpadding="2" cellspacing="2">
						<tr>
							...
							<td ><input name="Codigo" type="text" id="Codigo" size="16"/><label for="Codigo" generated="true" class="error"></label></td>
						</tr>
						<tr>
						...
						<tr>							
							...
							<td>
								<input name="Gerente_General" type="text" id="Gerente_General" size="50"/>
							</td>
					  	</tr>
						<tr>
		...
		<tr>
			<td valign="top">                                            
				<div style="display:block" id="div_res_new_vendedor">
					<INPUT  id="Bnt_Vendedor_Nuevo"  name="Bnt_Vendedor_Nuevo" type="button" value="Add" >
                </div>                                  					
           	</td>       
		</tr>
	</table>
</form>
<img src='images/spacer.gif' onload='Iniciar_Validacion_Vendedor_Nuevo();' />
<?php
