...
<div>
	...
	<FORM><input type="button" value="New Employee" onclick="Empresas_Nuevo_Empleado(<?php echo  $Emp_ID?>);" /></FORM>
...
<?php   				       	
	...
	$consulta = "SELECT * FROM personal WHERE Emp_ID=".$Emp_ID." ORDER BY Aux5, Nick_Name, Nombre";		
		...
		<tr >											
			...
			<td> 	
                 ...
                 <a style =" cursor: pointer;">
					...
					<img src="images/button_edit.gif" border="0" width="16" onclick="Empresas_Empleados_Editar(<?php echo $Empleado_ID; ?>, <?php echo $Emp_ID; ?>);" alt="Edit"/>	
                ...
                <a style =" cursor: pointer;">
					...
					<img src="images/icon_eliminar_0_gif.gif" border="0" width="16" onclick="Empresas_Empledos_Eliminar(<?php echo $Empleado_ID; ?>, <?php echo $Emp_ID; ?>);" alt="Delete"/>		
			...
			<td align="right" style="font-size:x-small"><?php echo  $Usuario; ?></td>
			
			<td align="right" style="font-size:x-small"><?php echo  $Password; ?></td>						
...
<img src="images/spacer.gif" onload="$('.Tabla_Lista_Empleados').flexigrid({nowrap: false, showTableToggleBtn : true,width : 1000,height :200, singleSelect: true	});" />	 
