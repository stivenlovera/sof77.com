...
<?php   				       
	...
	?>		
		<tr >											
			<td> 	
				 <a href="#">
					<img src="images/button_edit.gif" border="0" width="16" onclick="Empresas_Editar(<?php echo $Emp_ID; ?>);" alt="Edit"/>	
				</a>								
				<a href="#">
					<img src="images/icon_eliminar_0_gif.gif" border="0" width="16" onclick="Empresas_Eliminar(<?php echo $Emp_ID; ?>);" alt="Delete"/>		
				</a>				
			</td>
