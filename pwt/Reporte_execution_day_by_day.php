...
<script type="text/javascript" >
	...
	{	
		...
		url = 'Reporte_execution_day_by_day_preview.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&Pro_ID_Reporte='+Pro_ID_Reporte;			
				...
				<form id="form_reporte" name="form_reporte">			
					...
					<tr>
						...
						<td><p>
					      ...
					      <img src="images/buscar.jpg" onclick="Reporte_Actividades_lista_Proyectos();" /></p>
					  </td>
					</tr>
					<tr>
							<td colspan="2">
						...
						<tr>
							<td colspan="2" align="center"><a href="#">
							  <input name="button" type="button" onclick="reporte_daily_report_preview();" value="Print Prev" />
							</a>&nbsp;&nbsp;&nbsp;
								  <a href="#">
