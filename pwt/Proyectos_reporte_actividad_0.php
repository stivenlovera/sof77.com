...
<script type="text/javascript" >
	...
	function proyectos_reporte_actividad_1() 
	...
	{	
			...
			url = 'proyectos_reporte_actividad_1.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value;		
	...
	function proyectos_reporte_actividad_email() 
	{	
			url = 'proyectos_reporte_actividad_email.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value;		
			getAx(url,'basic-modal-content-espera',250);		
			$('#basic-modal-content-espera').modal(); 			
	}	
	
	
	function proyectos_reporte_actividad_email_bulk() 
	{	
		var costcode = $('input[name=costcode]:checked').val();
		var timesheet = $('input[name=timesheet]:checked').val();
	
			url = 'proyectos_reporte_actividad_email_bulk.php?vfrom_date='+form_reporte.From_Date.value+'&vto_date='+form_reporte.To_Date.value+'&costcode='+costcode+'&timesheet='+timesheet;		
			getAx(url,'basic-modal-content-espera',250);		
			$('#basic-modal-content-espera').modal(); 			
	}
	...
	function Proyectos_Repoprte_Actividad_email_bulk_send() 
	{	
		//alert("llegue");
		datos='';	
		url = 'Proyectos_Repoprte_Actividad_email_bulk_send.php';
		$(':input', $("#Form_Proyecto_Pedidos_Email_Send") ).each(function() {
			if ( (this.type!='submit') && ( this.type!='button') && ( this.type!='reset') && (this.type!='radio') )
			{
				cad=jQuery.trim(this.name);	
		...
		datos=datos+'&Contenido='+escape($('#wysiwyg').val());
		postAx(url,datos,'Res_envio',100);
	}	
				...
				<form id="form_reporte" name="form_reporte">			
					...
					<table width="267" class="moduletable" >
						...
						<tr>
							...
							<th colspan="3">Report shedule day by day</th>
						...
						<tr>
							...
							<td colspan="2" align="center">
								...
								<a href="#"><input name="button" type="button" onclick="proyectos_reporte_actividad_1();" value="Print Prev" /></a>&nbsp;&nbsp;&nbsp;

								<a href="#"><input name="button" type="button" onclick="proyectos_reporte_actividad_email();" value="email" /></a>&nbsp;&nbsp;&nbsp;
								<a href="#"><input name="button" type="button" onclick="proyectos_reporte_actividad_email_bulk();" value="email All" /></a>&nbsp;&nbsp;&nbsp;

							  	<a href="#"><input type="reset" value=" Clear "  /></a>															

					  </tr>					  					  
<tr>
							<td align="left" valign="top"><b>Option :</b></td>
							<td>
								<p>Send email about Cost Codes Pending
  <input name="costcode" type="radio"  id="costcode" value="Y"  />
							  </p>
							  <p>Send TimeSheets by email to all
                                <input name="timesheet" type="radio"  id="timesheet" value="Y"  />&nbsp;</p>
								<p><br>
							  </p>
